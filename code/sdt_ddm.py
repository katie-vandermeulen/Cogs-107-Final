...
def apply_hierarchical_sdt_model(data):
    ...
    stimulus_type = np.array([0, 1, 0, 1])
...
def analyze(file_path):
    ...
    trace_params = ["intercept_d_prime", "stimulus_d_prime", "difficulty_d_prime", "interaction_d_prime", "stimulus_criterion", "intercept_criterion", "difficulty_criterion", "interaction_criterion"]
...
def compare(trace, dp_data):
    print("\nSDT Summary:")
    sdt_summary = az.summary(trace, var_names=["stimulus_d_prime", "difficulty_d_prime", "interaction_d_prime", "stimulus_criterion", "difficulty_criterion", "interaction_criterion"])
    print(sdt_summary)
